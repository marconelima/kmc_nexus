			...
			<div id="header_top">
				<div id="header_top_inner">
					<div class="call_us"<?php echo get_theme_option('show_login')=='yes' ? '' : ' style="border-right:none;"'; ?>>
						<img src="<?php echo get_template_directory_uri(); ?>/assets/img/ico_telefone.png" alt=""  />
						<span class="ddd"><?php echo substr(get_theme_option('header_call_us'),0,2); ?></span><?php echo substr(get_theme_option('header_call_us'),2); ?>
					</div>
